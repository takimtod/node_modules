...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    ev: import("../Types").BaileysEventEmitter & {
        process(handler: (events: Partial<import("../Types").BaileysEventMap>) => void | Promise<void>): () => void; /** this mutex ensures that each retryRequest will wait for the previous one to finish */
        buffer(): void;
